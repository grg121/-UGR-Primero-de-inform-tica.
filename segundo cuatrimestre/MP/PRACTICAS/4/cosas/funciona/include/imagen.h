...
private:
   ...
   byte datos[MAXPIXELS];///< datos de la imagen CREAMOS UNSIGNED CHAR BYTE LLAMADO DATOS(un char de 0 a 254 bits)
...
/* Metodo que dado un numero k, extae el plano de bits k-esimo de la inmagen actual y lo devuelva como una nueva imagen.*/
    Imagen plano (int k);
